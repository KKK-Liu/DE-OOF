...
class SRNATT_Net(nn.Module, BaseModel):
    def __init__(self, args) -> None:
        super(SRNATT_Net, self).__init__()
    ...
    def train_step(self):
        ...
        self.train_loss_all = (self.train_loss_mse_1 + self.train_loss_mse_2 + self.train_loss_mse_3)/3
