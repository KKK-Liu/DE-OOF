...
class ATT_Deblur_Net_level4(nn.Module, BaseModel):
    def __init__(self, args) -> None:
        super(ATT_Deblur_Net_level4, self).__init__()
    ...
    def train_step(self):
        ...
        with autocast():
            ...
            self.train_loss_consistency_confidence =\
                self.loss_function_l1(self.upsample_fn(self.attention_4, (64 ,64 )), self.attention_3) +\
            ...
            self.train_loss_consistency = \
                self.loss_function_l1(self.upsample_fn(self.restored_images_4, (64 ,64 )), self.restored_images_3) +\
