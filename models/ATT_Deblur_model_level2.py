...
class ATT_Deblur_Net_level2(nn.Module, BaseModel):
    def __init__(self, args) -> None:
        super(ATT_Deblur_Net_level2, self).__init__()
    ...
    def train_step(self):
        ...
        with autocast():
            ...
            self.train_loss_all =   self.train_loss_l1_1 + self.train_loss_l1_2+\
                                    self.lambda_RR * self.train_loss_consistency +\
                                    self.lambda_CM * self.train_loss_consistency_confidence
    ...
    def valid_step(self):
        with torch.no_grad():
            with autocast():
                ...
                self.valid_loss_all =   self.valid_loss_l1_1 + self.valid_loss_l1_2+\
